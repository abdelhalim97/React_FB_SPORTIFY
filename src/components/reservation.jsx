        ...
        <Paper className='w-full mb-3'>
          <TableContainer key={i} component={Paper} className='mb-3'>
            <Table sx={{ minWidth: 650 }} aria-label="simple table">
              ...
              <TableBody>
                {(rowsPerPage > 0? dataReservations.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage): dataReservations).map((row) => ( 
          ...
          <TablePagination rowsPerPageOptions={[5, 10, 25, { label: 'All', value: -1 }]} colSpan={3} count={dataReservations.length} rowsPerPage={rowsPerPage}  
